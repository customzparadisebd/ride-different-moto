  ...
  return (
    <section className="mx-auto max-w-md px-4 py-20 text-center">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Your account cannot use this area. This happens when access is still <strong>Pending</strong>{" "}
        approval, has been suspended or revoked, or the session was revoked by a Super Admin. Contact
        the Super Admin if you believe this is a mistake.
      </p>
