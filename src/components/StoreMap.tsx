...
// `q` = business name so the pin renders with the "Customz Paradise BD" label,
// `ll` pins it to the exact listing coordinates.
const MAP_EMBED_SRC =
  "https://www.google.com/maps?q=Customz+Paradise+BD&ll=23.8881991,90.378464&z=16&hl=en&output=embed";
const MAP_LINK =
