...
function NotFoundComponent() {
    ...
    return (<div className="flex min-h-screen items-center justify-center bg-background px-4 py-12">
      <div className="w-full max-w-lg text-center">
        <div className="relative mx-auto mb-10 w-full max-w-[320px] overflow-hidden rounded-xl bg-muted/30 sm:max-w-[500px] lg:max-w-[600px]">
          <img src={errorGif.url} alt="Page not found" className="h-auto w-full object-contain transition-transform duration-500 hover:scale-105" loading="eager"/>
        </div>
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          <Link to={isPrivateArea ? "/ad" : "/"} className="inline-flex min-w-[160px] items-center justify-center rounded-sm bg-primary px-8 py-3 text-sm font-bold uppercase tracking-widest text-primary-foreground transition-all hover:bg-primary/90 hover:ring-2 hover:ring-primary/20">
            {isPrivateArea ? "Back to Dashboard" : "Back to Home"}
          </Link>
          <button onClick={() => window.history.back()} className="inline-flex min-w-[160px] items-center justify-center rounded-sm border-2 border-input bg-transparent px-8 py-3 text-sm font-bold uppercase tracking-widest text-foreground transition-all hover:bg-accent hover:text-accent-foreground">
            Go Back
          </button>
        </div>
      </div>
