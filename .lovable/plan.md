...
- Ensure `mfaSatisfied` is required *before* any staff status or session approval logic is considered terminal.
...
- Ensure the "Waiting for Approval" screen only appears *after* identity (Login + MFA) is fully established.
