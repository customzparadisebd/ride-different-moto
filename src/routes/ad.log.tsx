          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-12 border-white/5 bg-white/5 font-medium transition-all focus:border-primary/50 focus:ring-primary/20 text-white placeholder:text-white/20 autofill:!bg-[#0a0a0a] autofill:!text-white [-webkit-text-fill-color:white]"
            ...
            <div className="space-y-2">
              ...
              <PasswordInput
                ...
                className="h-12 border-white/5 bg-white/5 transition-all focus:border-primary/50 focus:ring-primary/20 text-white placeholder:text-white/20 autofill:!bg-[#0a0a0a] autofill:!text-white [-webkit-text-fill-color:white]"
                placeholder="••••••••"
              />
            </div>
